...
export class ServerGame {
    ...
    addPlayer(playerId, team) {
        ...
        character.id = playerId; // Store playerId on the entity for easy serialization
    ...
    handleUpgrade(character, type) {
        // Простая система прокачки: всё стоит 50 золота
        const cost = 50;
    ...
    broadcastState() {
        ...
        // Extract relevant render info for all entities
        for (const entity of this.entityManager.entities) {
            if (entity instanceof Character) {
                state.entities.push({
                    type: 'CHARACTER',
                    id: entity.id, // to map to player
                    x: entity.x,
                    y: entity.y,
                    team: entity.team,
                    hp: entity.hp,
                ...
                state.entities.push({
                    ...
                    radius: entity.radius // to draw correct size
                });
            }
        }
