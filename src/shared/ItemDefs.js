...
export const SHOP_ITEMS = [
    ...
    { id: 'grappling_hook', label: 'Grappling Hook', cost: 200, icon: 'assets/shop/Grappling_Hook.png', desc: 'Active: Next hook pulls you to walls', effect: 'grapple', active: true, cooldown: 5 },
    { id: 'naix_jaws', label: "Naix's Jaws", cost: 150, icon: 'assets/shop/naix\'s_jaws.png', desc: 'Heal 20 HP on hook hit', effect: 'lifesteal' },
    ...
    { id: 'lycan_paws', label: "Lycan's Paws", cost: 100, icon: 'assets/shop/Lycan\'s_Paws.png', desc: '+40 Move Speed', effect: 'speed' },
