...
export const SHOP_ITEMS = [
    ...
    { id: 'healing_salve', label: 'Healing Salve', cost: 100, icon: 'assets/shop/Healling_salve.png', desc: 'Regen 100 HP over 20s', effect: 'heal', active: true, consumable: true, cooldown: 20 },
